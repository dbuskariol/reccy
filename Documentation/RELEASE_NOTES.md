...
The first development release establishes Reccy as a macOS-native capture and editing workspace:

- Display, portion, application, and window recording with clear source boundaries.
- Separate system-audio and microphone tracks, live monitoring, pause/resume, and source-aware menu-bar controls.
...
- A compact recording library with rich source, audio, video, and pointer metadata.
